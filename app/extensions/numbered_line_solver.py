...
_TEMPLATE_COUNT = 18
# Three medoid glyphs per digit cover both dark and translucent numbered-circle renderings.
_TEMPLATE_BLOB = (
...
def solve_numbered_line_drag(
    ...
    options = []
    for digit_count, source_label in ((5, 4), (6, 3)):
    ...
    debug_path = challenge_screenshot.with_name(
        challenge_screenshot.name.replace("_challenge_view.png", "_numbered_solution.png")
    )
